        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
              ...
              <div class="carousel-caption">
                <a href="https://playvalorant.com/en-gb/" rel="noopener" ><button class="btn button-49">Play Now</button></a>
              </div>  
            </div>
            <div class="carousel-item">
              <img src="https://images.alphacoders.com/118/thumbbig-1186644.webp" alt="Chicago" style={carouelImg} class="d-block w-100"/>
              <div class="carousel-caption">
                <a href="https://playvalorant.com/en-gb/" ><button class="btn button-49 ">Play Now</button></a>
              </div>  
            </div>
            <div class="carousel-item">

...
const Page404 = () => {
  return (
    <div>
      <Header/>
      <div className="container d-sm-flex justify-content-center border" style={{height:'80vh'}}>
        <div className="my-auto text-right border ">
        <h1 className="text-light mt-sm-0 mt-4" style={{fontSize:'30vh'}}>404</h1>
        </div>
        <div className="my-auto mx-2 border">
